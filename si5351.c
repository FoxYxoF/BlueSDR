...
uint8_t si5351_write(uint8_t reg, uint8_t value) {
    ...
    while (!(I2C1->SR1 & I2C_SR1_SB)) {
        if (--timeout == 0) {
            ILI9341_WriteString(46, 0, "Error SI5351", Font_11x18, GREEN, MYFON);
			      ILI9341_WriteString(46, 0+18, "Start Flag", Font_11x18, GREEN, MYFON);
            I2C1_ForceReset();
            return 0; 
        }
    }
    ...
    while (!(I2C1->SR1 & (I2C_SR1_ADDR | I2C_SR1_AF))) {
        if (--timeout == 0) {
            ILI9341_WriteString(46, 0, "Error SI5351", Font_11x18, GREEN, MYFON);
			      ILI9341_WriteString(46, 0+18, "Addr Timeout", Font_11x18, GREEN, MYFON);
            I2C1_ForceReset();
            return 0; 
        }
    }
    ...
    if (I2C1->SR1 & I2C_SR1_AF) {
        ...
        I2C1->CR1 |= I2C_CR1_STOP;  
        ILI9341_WriteString(46, 0, "Error SI5351", Font_11x18, GREEN, MYFON);
			  ILI9341_WriteString(46, 0+18, "No ACK (Disconnect)", Font_11x18, GREEN, MYFON);
        return 0;                   
    }
    ...
    while (!(I2C1->SR1 & I2C_SR1_TXE)) {
        if (--timeout == 0 || (I2C1->SR1 & I2C_SR1_AF)) {
            ...
            I2C1->CR1 |= I2C_CR1_STOP;
            ILI9341_WriteString(46, 0, "Error SI5351", Font_11x18, GREEN, MYFON);
			      ILI9341_WriteString(46, 0+18, "Reg Write", Font_11x18, GREEN, MYFON);
            return 0;
        }
    }
    ...
    while (!(I2C1->SR1 & I2C_SR1_BTF)) {
        if (--timeout == 0 || (I2C1->SR1 & I2C_SR1_AF)) {
            ...
            I2C1->CR1 |= I2C_CR1_STOP;
            ILI9341_WriteString(46, 0, "Error SI5351", Font_11x18, GREEN, MYFON);
			      ILI9341_WriteString(46, 0+18, "Data Write", Font_11x18, GREEN, MYFON);			
            return 0;
        }
    }
